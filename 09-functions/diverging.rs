/*  Diverging functions
    ...
    cast to any other one and therefore used at places where an exact type is 
    required, for instance in match branches. This allows us to write code 
    like this: */
    ...
    fn sum_odd_numbers(up_to: u32) -> u32 {
        ...
        for i in 0..up_to {
            ...
            let addition: u32 = match i % 2 == 1 {
                ...
                // therefore does not violate the type requirements of the match 
                // expression.
                false => continue,
            };
            acc += addition;
